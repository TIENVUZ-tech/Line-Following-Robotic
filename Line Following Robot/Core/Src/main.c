...
static void MX_TIM2_Init(void)
{
  ...
  TIM_OC_InitTypeDef sConfigOC = {0}; // Add this struct!
...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_5;
    ...
    /* Configure PB3 for TIM2_CH2 (Right Motor PWM) */
  ...
  /* Configure Sensor Pins as Digital Inputs (PA0, PA1, PA4) */
    GPIO_InitStruct.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_4;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    /* Configure Sensor Pin (PB0) */
    GPIO_InitStruct.Pin = GPIO_PIN_0;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    /* Configure Sensor Pin (PC1) */
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
	if (GPIO_Pin == GPIO_PIN_13) {
		g_running = !g_running; // Toggle state
		if (!g_running) {
			motor_control(0, 0);
			g_state = STATE_STOP;
		}
